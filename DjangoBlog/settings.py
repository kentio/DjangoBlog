...
SECRET_KEY = os.getenv('BLOG_SECRET_KEY') if os.getenv(
    'BLOG_SECRET_KEY') else 'n9ceqv38)#&mwuat@(mjb_p%em$e8$qyr#fw9ot!=ba6lijx-6'
...
# ALLOWED_HOSTS = []
ALLOWED_HOSTS = ['localhost', '127.0.0.1', os.getenv("DOMAIN_NAME", "example.com")]
